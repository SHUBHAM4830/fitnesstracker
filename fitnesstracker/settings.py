...
SECRET_KEY = 'django-insecure-l7b0=4&a-gox=c^ys#c1ykftlj*am(bqhjt2m6%jk*8wpm=(ge'
...
LOGIN_URL = '/login/'
LOGIN_REDIRECT_URL = 'activity_list'  # Redirect users to the activity list after login
